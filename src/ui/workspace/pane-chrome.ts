...
export function createPaneChrome<TKey extends string>({
  ...
  symPriceLabel.style.cssText = "font-size:18px;font-weight:600;color:#9aa7c1;white-space:nowrap;line-height:1;font-variant-numeric:tabular-nums;font-family:-apple-system,BlinkMacSystemFont,'Trebuchet MS',Roboto,Ubuntu,sans-serif;flex-shrink:0;margin-right:4px;";
  ...
  const applyResponsive = () => {
    ...
    if (width < 560) {
      ...
      symPriceLabel.style.fontSize = '18px';
