...
const MOBILE_DRAWING_TOOLS: MobileDrawingTool[] = [
  ...
  { id: 'fib-retracement', title: '피보나치', svg: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="4" x2="21" y2="4"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="3" y1="14" x2="21" y2="14"/><line x1="3" y1="19" x2="21" y2="19"/><line x1="6.5" y1="16.5" x2="17.5" y2="11.5" stroke-dasharray="4 3"/><circle cx="5" cy="17" r="1.8" fill="#d8d8d8"/><circle cx="19" cy="11" r="1.8" fill="#d8d8d8"/></svg>' },
  { id: 'fib-trend', title: '추세피보', svg: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><line x1="3" y1="4" x2="21" y2="4"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="3" y1="16" x2="21" y2="16"/><polyline points="5,17 12,10 19,14" stroke-dasharray="4 3"/><circle cx="5" cy="17" r="1.8" fill="#d8d8d8"/><circle cx="12" cy="10" r="1.8" fill="#d8d8d8"/><circle cx="19" cy="14" r="1.8" fill="#d8d8d8"/></svg>' },
