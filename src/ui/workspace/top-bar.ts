...
export function createTopBar({
  ...
  signalBtn.innerHTML = `
    <span style="position:relative;display:inline-flex;width:22px;height:22px;align-items:center;justify-content:center;">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 55.5" width="18" height="18" fill="none" aria-hidden="true" style="opacity:0.92;">
        <path d="M32.98,48c-.26,4.19-3.73,7.5-7.98,7.5s-7.73-3.31-7.98-7.5H5.01c-2.77,0-5.01-2.24-5.01-5s2.24-5,5-5c.55,0,1-.45,1-1v-12c0-8.46,5.57-15.8,13.5-18.19v-1.31c0-3.04,2.47-5.5,5.5-5.5s5.5,2.46,5.5,5.5v1.31c7.93,2.39,13.5,9.74,13.5,18.19v12c0,.56.44,1,1,1,2.76,0,5,2.24,5,5s-2.24,5-5.01,5h-12.01ZM30.98,48h-11.96c.25,3.08,2.83,5.5,5.98,5.5s5.73-2.42,5.98-5.5ZM20.75,8.54c-7.45,1.92-12.75,8.66-12.75,16.46v12c0,1.66-1.34,3-3,3s-3,1.35-3,3,1.35,3,3.01,3h39.98c1.66,0,3.01-1.35,3.01-3s-1.35-3-3-3-3-1.34-3-3v-12c0-7.8-5.3-14.55-12.75-16.46l-.75-.19v-2.84c0-1.94-1.56-3.5-3.5-3.5s-3.5,1.57-3.5,3.5v2.84l-.75.19Z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
      </svg>
  ...
  logo.innerHTML = `<img src="/images/TC-logo.png" alt="TC Chart" style="height:22px;width:auto;display:block;object-fit:contain;" />`;
