...
export function createTopBar({
  ...
  signalBtn.innerHTML = `
    <span style="position:relative;display:inline-flex;width:24px;height:24px;align-items:center;justify-content:center;">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125" width="21" height="21" fill="none" aria-hidden="true">
        <g stroke="none" stroke-width="1" fill-rule="evenodd">
          <g fill-rule="nonzero" fill="currentColor">
            <path d="M57.984629,70.5 C57.7265308,74.6853649 54.2503527,78 50,78 C45.7496473,78 42.2734692,74.6853649 42.015371,70.5 L30.0098932,70.5 C27.2426998,70.5 25,68.2623562 25,65.5 C25,62.7415758 27.2410057,60.5 30.0020869,60.5 C30.5506171,60.5 31,60.0503408 31,59.4982567 L31,47.4992494 C31,39.0414536 36.5688745,31.6989711 44.5,29.3079837 L44.5,28.0008537 C44.5,24.9644303 46.9658756,22.5 50,22.5 C53.0394304,22.5 55.5,24.9588257 55.5,28.0008537 L55.5,29.3080901 C63.4309012,31.6993876 69,39.0432802 69,47.4992494 L69,59.4982567 C69,60.0559447 69.444271,60.5 69.9979131,60.5 C72.7545482,60.5 75,62.7410309 75,65.5 C75,68.2588607 72.7550604,70.5 69.9901068,70.5 L57.984629,70.5 Z M55.9794631,70.5 L44.0205369,70.5 C44.2746123,73.5797653 46.8546681,76 50,76 C53.1453319,76 55.7253877,73.5797653 55.9794631,70.5 Z M45.7491484,31.0352577 C38.2995667,32.9517446 33,39.6950944 33,47.4992494 L33,59.4982567 C33,61.1546353 31.6554619,62.5 30.0020869,62.5 C28.3456891,62.5 27,63.8460315 27,65.5 C27,67.1567749 28.3462601,68.5 30.0098932,68.5 L69.9901068,68.5 C71.6512487,68.5 73,67.153532 73,65.5 C73,63.8464837 71.6508601,62.5 69.9979131,62.5 C68.3399188,62.5 67,61.1607317 67,59.4982567 L67,47.4992494 C67,39.6969028 61.7001155,32.9520218 54.250817,31.0353237 L53.5,30.8421392 L53.5,28.0008537 C53.5,26.0637128 51.9351782,24.5 50,24.5 C48.0701827,24.5 46.5,26.0692624 46.5,28.0008537 L46.5,30.8420929 L45.7491484,31.0352577 Z"/>
          </g>
        </g>
      </svg>
      <span data-signal-badge style="position:absolute;top:1px;right:-3px;height:14px;min-width:14px;padding:0 3px;background:#d91f3a;color:#fff;border:none;border-radius:999px;font:700 8px/1 Segoe UI,Arial,sans-serif;display:none;align-items:center;justify-content:center;box-sizing:border-box;">0</span>
    </span>
  `;
  ...
  logo.title = '홈';
  logo.innerHTML = `<span class="tc-brand-word tc-brand-trading" data-text="TRADING" style="font-weight:700;font-size:14.4px;"><span class="tc-trading-letter" style="--i:0;">T</span><span class="tc-trading-letter" style="--i:1;">R</span><span class="tc-trading-letter" style="--i:2;">A</span><span class="tc-trading-letter" style="--i:3;">D</span><span class="tc-trading-letter" style="--i:4;">I</span><span class="tc-trading-letter" style="--i:5;">N</span><span class="tc-trading-letter" style="--i:6;">G</span></span><span class="tc-brand-word tc-brand-core" data-text="CORE" style="font-weight:800;font-size:14.4px;"><span class="tc-core-letter" style="--i:0;">C</span><span class="tc-core-letter" style="--i:1;">O</span><span class="tc-core-letter" style="--i:2;">R</span><span class="tc-core-letter" style="--i:3;">E</span></span>`;
