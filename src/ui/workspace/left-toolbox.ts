...
const eraserIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12.5 12.5" width="22" height="22"><rect fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width=".5" x=".56" y="2.55" width="11.38" height="7.4" rx="1.55" ry="1.55" transform="translate(-2.59 6.25) rotate(-45)"/><path fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width=".5" d="M5.17,12.22h6.02-6.02Z"/><path fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width=".5" d="M2.25,5.34l5.21,5.21L2.25,5.34Z"/></svg>`;
