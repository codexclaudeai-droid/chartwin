...
const DEFAULT_LINE_STYLES: Record<string, LineStyle> = {
  ...
  vwapUpper1: { color: 'rgba(255,152,0,0.62)', width: 1, dash: [] },
  vwapLower1: { color: 'rgba(255,152,0,0.62)', width: 1, dash: [] },
  vwapUpper2: { color: 'rgba(255,193,7,0.52)', width: 1, dash: [5, 4] },
  ...
  smartMoneyConceptsInternalBearish: { color: '#f23645', width: 1, dash: [5, 4] },
  smartMoneyConceptsEqual: { color: '#878b94', width: 1, dash: [2, 3] },
  ...
  fixedRangeVolumeProfileUp: { color: 'rgba(38,166,154,0.45)', width: 1, dash: [] },
  fixedRangeVolumeProfileDown: { color: 'rgba(239,83,80,0.45)', width: 1, dash: [] },
  fixedRangeVolumeProfilePoc: { color: 'rgba(255,193,7,0.95)', width: 1.2, dash: [4, 3] },
  ...
  atrTrailingEmaSignalAtrStop: { color: '#8ab4ff', width: 1.4, dash: [5, 4] },
  atrTrailingEmaSignalBuy: { color: '#00ff55', width: 1, dash: [] },
  atrTrailingEmaSignalSell: { color: '#ff0040', width: 1, dash: [] },
  atrTrailingStopOriginTrendEma: { color: '#fcfc6c', width: 3, dash: [] },
  atrTrailingStopOriginAtrStop: { color: '#8ab4ff', width: 1.4, dash: [5, 4] },
  atrTrailingStopOriginBuy: { color: '#00ff55', width: 1, dash: [] },
  atrTrailingStopOriginSell: { color: '#ff0040', width: 1, dash: [] },
  bbMtfKalmanLtfBasis: { color: '#2962ff', width: 1, dash: [] },
  bbMtfKalmanLtfUpper: { color: '#f23645', width: 1, dash: [] },
  bbMtfKalmanLtfLower: { color: '#089981', width: 1, dash: [] },
  bbMtfKalmanHtfUpper: { color: '#ffffff', width: 1, dash: [] },
...
export const INDICATOR_STYLE_TARGETS: Record<string, { key: string; label: string }[]> = {
  ...
  vwap: [
    { key: 'vwap', label: 'VWAP' },
    { key: 'vwapUpper1', label: 'Upper #1' },
    { key: 'vwapLower1', label: 'Lower #1' },
    { key: 'vwapUpper2', label: 'Upper #2' },
    { key: 'vwapLower2', label: 'Lower #2' },
  ...
  smartMoneyConcepts: [
    ...
    { key: 'smartMoneyConceptsInternalBullish', label: 'Internal Bullish' },
    { key: 'smartMoneyConceptsInternalBearish', label: 'Internal Bearish' },
    { key: 'smartMoneyConceptsEqual', label: 'Equal High/Low' },
  ],
  ...
  fixedRangeVolumeProfile: [
    { key: 'fixedRangeVolumeProfileUp', label: 'Bull Volume' },
    { key: 'fixedRangeVolumeProfileDown', label: 'Bear Volume' },
    { key: 'fixedRangeVolumeProfilePoc', label: 'POC' },
  ],
  ...
  atrTrailingEmaSignal: [
    { key: 'atrTrailingEmaSignalTrendEma', label: 'Trend EMA' },
    { key: 'atrTrailingEmaSignalAtrStop', label: 'ATR Stop' },
    { key: 'atrTrailingEmaSignalBuy', label: 'Buy' },
    { key: 'atrTrailingEmaSignalSell', label: 'Sell' },
  ],
  atrTrailingStopOrigin: [
    { key: 'atrTrailingStopOriginTrendEma', label: 'Trend EMA' },
    { key: 'atrTrailingStopOriginAtrStop', label: 'ATR Stop' },
    { key: 'atrTrailingStopOriginBuy', label: 'Buy' },
    { key: 'atrTrailingStopOriginSell', label: 'Sell' },
  ],
  bbMtfKalmanSignal: [
    { key: 'bbMtfKalmanLtfBasis', label: 'LTF Basis' },
    { key: 'bbMtfKalmanLtfUpper', label: 'LTF Upper' },
    { key: 'bbMtfKalmanLtfLower', label: 'LTF Lower' },
    { key: 'bbMtfKalmanHtfUpper', label: 'HTF Upper' },
    { key: 'bbMtfKalmanHtfLower', label: 'HTF Lower' },
